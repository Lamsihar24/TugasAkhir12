                                    ...
                                    <div class="payment_method">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="metodePembayaran1">
                                              <img src="{{ asset('img/icon/bank/img_bankid_bca.png') }}" alt=""> Bank BCA (Dicek otomatis)
                                            </label>
                                          </div>
                                          <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="metodePembayaran2">
                                                <img src="{{ asset('img/icon/bank/img_bankid_bni.png') }}" alt=""> Bank BNI (Dicek otomatis)
                                            </label>
                                          </div>
                                          <div class="form-check disabled">
                                            ...
                                            <label class="form-check-label" for="metodePembayaran3">
                                                <img src="{{ asset('img/icon/bank/img_bankid_bri.png') }}" alt=""> Bank BRI (Dicek otomatis)
                                            </label>
                                          </div>
                                          <div class="form-check disabled">
                                            ...
                                            <label class="form-check-label" for="metodePembayaran4">
                                                <img src="{{ asset('img/icon/bank/img_bankid_mandiri.png') }}" alt=""> Bank Mandiri (Dicek otomatis)
                                            </label>
                                          </div>
                                    </div>
                                </div>
